	...
	<div class="mainWrapper">
		...
		<div class="contentWrapper">
			...
			<div class="contentArea">
				...
				<div id="productBox" style="height: 750px;">
					<?php
						if (isset($_GET['proId'])) {
							...
							while($rowProduct=mysqli_fetch_array($runProduct)){
								...
								echo "
									...
									<div id='singleProductDetails'>
										...
										<h6>&#8377;$productPrice</h6>
										<p>$productDesc</p>
										<a href='index.php?proId=$productId' style='float:right;'><button class='w3-button w3-round-large'>Add to Cart</button></a>
										<a href='index.php'><button class='w3-button w3-round-large'>Go back</button>
									</div>
								";
							}
						}
